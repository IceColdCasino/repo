...
void VerifyKey_14_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void VerifyKey_14_run(uint ctx_index,Circom_CalcWit* ctx);
...
void Encrypt_20_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Encrypt_20_run(uint ctx_index,Circom_CalcWit* ctx);
void Register_21_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Register_21_run(uint ctx_index,Circom_CalcWit* ctx);
void BASE8_0(Circom_CalcWit* ctx,FrElement* lvar,uint componentFather,FrElement* destination,int destination_size);
...
uint get_total_signal_no() {return 28143;}

uint get_number_of_components() {return 2930;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 3859;}
...
FrElement expaux[1];
std::string myTemplateName = "BASE8";
...
// return bucket
Fr_copyn(destination,&lvar[0],std::min(2,destination_size));
return;
}
...
Num2Bits_0_create(mySignalStart+9860,950+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 950+ctx_index+1;
}
{
std::string new_cmp_name = "mulFix";
EscalarMulFix_10_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
...
IsZero_12_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
...
ctx->componentMemory[coffset].templateName = "VerifyKey";
ctx->componentMemory[coffset].signalStart = soffset;
...
int cmp_index_ref_load = -1;
{
std::string new_cmp_name = "babyPbk";
BabyPbk_11_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint aux_create = 1;
int aux_cmp_num = 952+ctx_index+1;
uint csoffset = mySignalStart+10117;
uint aux_dimensions[1] = {2};
for (uint i = 0; i < 2; i++) {
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
BabyPbk_11_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &lvar[0];
// load src
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[8]); // line circom 229
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[2]); // line circom 229
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[8]); // line circom 229
...
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
Fr_mul(&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 237
{{
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 237
}}
...
MontgomeryDouble_2_create(mySignalStart+16,1+ctx_index+1,ctx,new_cmp_name,myId);
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_1_create(mySignalStart+4417,588+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[147] = 588+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_6_create(mySignalStart+4438,591+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[148] = 591+ctx_index+1;
}
{
std::string new_cmp_name = "eadder";
BabyAdd_7_create(mySignalStart+4421,589+ctx_index+1,ctx,new_cmp_name,myId);
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_1_create(mySignalStart+3127,416+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[104] = 416+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_6_create(mySignalStart+3148,419+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[105] = 419+ctx_index+1;
}
{
std::string new_cmp_name = "eadder";
BabyAdd_7_create(mySignalStart+3131,417+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[106] = 417+ctx_index+1;
}
{
std::string new_cmp_name = "lastSel";
Multiplexor2_15_create(mySignalStart+3141,418+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[107] = 418+ctx_index+1;
}
{
...
{
std::string new_cmp_name = "segments[0]";
SegmentMulAny_17_create(mySignalStart+277,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "segments[1]";
SegmentMulAny_18_create(mySignalStart+4719,596+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 596+ctx_index+1;
}
{
std::string new_cmp_name = "doublers";
MontgomeryDouble_2_create(mySignalStart+267,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_6_create(mySignalStart+273,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "adders";
BabyAdd_7_create(mySignalStart+257,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "zeropoint";
IsZero_12_create(mySignalStart+7871,1017+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 1017+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
ctx->componentMemory[coffset].templateName = "Encrypt";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 5;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
int cmp_index_ref_load = -1;
{
std::string new_cmp_name = "randomnessBits";
Num2Bits_0_create(mySignalStart+17750,1970+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 1970+ctx_index+1;
}
{
std::string new_cmp_name = "c0Mul";
EscalarMulFix_10_create(mySignalStart+9,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "rPk";
EscalarMulAny_19_create(mySignalStart+9876,951+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 951+ctx_index+1;
}
{
std::string new_cmp_name = "c1Add";
BabyAdd_7_create(mySignalStart+9866,950+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 950+ctx_index+1;
}
{
uint cmp_index_ref = 0;
{
...
cmp_index_ref_load = 0;
// end load src
Fr_copyn(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],253);
}
// need to run sub component
...
ctx->componentMemory[coffset].templateName = "Register";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 3;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
int cmp_index_ref_load = -1;
{
std::string new_cmp_name = "verifyKey";
VerifyKey_14_create(mySignalStart+18013,1972+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 1972+ctx_index+1;
}
{
std::string new_cmp_name = "encrypt";
Encrypt_20_create(mySignalStart+9,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 2;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
VerifyKey_14_run(mySubcomponents[cmp_index_ref],ctx);
}
{
uint cmp_index_ref = 1;
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Encrypt_20_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
Register_21_create(1,0,ctx,"main",0);
Register_21_run(0,ctx);
}

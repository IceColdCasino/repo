...
extern "c" fn poker_share_loadCircuitFromData(data: [*c]const u8, size: usize, vtable: *anyopaque) ?*anyopaque;
extern "c" fn poker_share_create_ctx(circuit: *anyopaque) ?*anyopaque;
extern "c" fn poker_share_get_main_input_signal_start() u32;
extern "c" fn poker_share_get_main_input_signal_no() u32;
extern "c" fn poker_share_get_total_signal_no() u32;
extern "c" fn poker_share_get_number_of_components() u32;
extern "c" fn poker_share_get_size_of_input_hashmap() u32;
extern "c" fn poker_share_get_size_of_witness() u32;
extern "c" fn poker_share_get_size_of_constants() u32;
extern "c" fn poker_share_get_size_of_io_map() u32;
extern "c" fn poker_share_get_size_of_bus_field_map() u32;

extern "c" fn poker_showdown_loadCircuitFromData(data: [*c]const u8, size: usize, vtable: *anyopaque) ?*anyopaque;
extern "c" fn poker_showdown_create_ctx(circuit: *anyopaque) ?*anyopaque;
extern "c" fn poker_showdown_get_main_input_signal_start() u32;
extern "c" fn poker_showdown_get_main_input_signal_no() u32;
extern "c" fn poker_showdown_get_total_signal_no() u32;
extern "c" fn poker_showdown_get_number_of_components() u32;
extern "c" fn poker_showdown_get_size_of_input_hashmap() u32;
extern "c" fn poker_showdown_get_size_of_witness() u32;
extern "c" fn poker_showdown_get_size_of_constants() u32;
extern "c" fn poker_showdown_get_size_of_io_map() u32;
extern "c" fn poker_showdown_get_size_of_bus_field_map() u32;
...
fn getCircuitFunctions(name: []const u8) ?struct {
    ...
    if (std.mem.eql(u8, name, "poker_share")) {
        return .{
            .loadCircuit = poker_share_loadCircuitFromData,
            .create_ctx = poker_share_create_ctx,
            .get_size = poker_share_get_size_of_witness,
            .vtable = .{
                .get_main_input_signal_start = poker_share_get_main_input_signal_start,
                .get_main_input_signal_no = poker_share_get_main_input_signal_no,
                .get_total_signal_no = poker_share_get_total_signal_no,
                .get_number_of_components = poker_share_get_number_of_components,
                .get_size_of_input_hashmap = poker_share_get_size_of_input_hashmap,
                .get_size_of_witness = poker_share_get_size_of_witness,
                .get_size_of_constants = poker_share_get_size_of_constants,
                .get_size_of_io_map = poker_share_get_size_of_io_map,
                .get_size_of_bus_field_map = poker_share_get_size_of_bus_field_map,
            },
        };
    } else
    if (std.mem.eql(u8, name, "poker_showdown")) {
        return .{
            .loadCircuit = poker_showdown_loadCircuitFromData,
            .create_ctx = poker_showdown_create_ctx,
            .get_size = poker_showdown_get_size_of_witness,
            .vtable = .{
                .get_main_input_signal_start = poker_showdown_get_main_input_signal_start,
                .get_main_input_signal_no = poker_showdown_get_main_input_signal_no,
                .get_total_signal_no = poker_showdown_get_total_signal_no,
                .get_number_of_components = poker_showdown_get_number_of_components,
                .get_size_of_input_hashmap = poker_showdown_get_size_of_input_hashmap,
                .get_size_of_witness = poker_showdown_get_size_of_witness,
                .get_size_of_constants = poker_showdown_get_size_of_constants,
                .get_size_of_io_map = poker_showdown_get_size_of_io_map,
                .get_size_of_bus_field_map = poker_showdown_get_size_of_bus_field_map,
            },
        };
    } else
    {
...
fn getCircuitData(name: []const u8) ![]const u8 {
    if (std.mem.eql(u8, name, "poker_share")) return witness_dat.getCircuitDat("poker_share");
    if (std.mem.eql(u8, name, "poker_showdown")) return witness_dat.getCircuitDat("poker_showdown");

...
extern "c" fn war_share_loadCircuitFromData(data: [*c]const u8, size: usize, vtable: *anyopaque) ?*anyopaque;
extern "c" fn war_share_create_ctx(circuit: *anyopaque) ?*anyopaque;
extern "c" fn war_share_get_main_input_signal_start() u32;
extern "c" fn war_share_get_main_input_signal_no() u32;
extern "c" fn war_share_get_total_signal_no() u32;
extern "c" fn war_share_get_number_of_components() u32;
extern "c" fn war_share_get_size_of_input_hashmap() u32;
extern "c" fn war_share_get_size_of_witness() u32;
extern "c" fn war_share_get_size_of_constants() u32;
extern "c" fn war_share_get_size_of_io_map() u32;
extern "c" fn war_share_get_size_of_bus_field_map() u32;

extern "c" fn war_showdown_loadCircuitFromData(data: [*c]const u8, size: usize, vtable: *anyopaque) ?*anyopaque;
extern "c" fn war_showdown_create_ctx(circuit: *anyopaque) ?*anyopaque;
extern "c" fn war_showdown_get_main_input_signal_start() u32;
extern "c" fn war_showdown_get_main_input_signal_no() u32;
extern "c" fn war_showdown_get_total_signal_no() u32;
extern "c" fn war_showdown_get_number_of_components() u32;
extern "c" fn war_showdown_get_size_of_input_hashmap() u32;
extern "c" fn war_showdown_get_size_of_witness() u32;
extern "c" fn war_showdown_get_size_of_constants() u32;
extern "c" fn war_showdown_get_size_of_io_map() u32;
extern "c" fn war_showdown_get_size_of_bus_field_map() u32;
...
fn getCircuitFunctions(name: []const u8) ?struct {
    ...
    if (std.mem.eql(u8, name, "war_share")) {
        return .{
            .loadCircuit = war_share_loadCircuitFromData,
            .create_ctx = war_share_create_ctx,
            .get_size = war_share_get_size_of_witness,
            .vtable = .{
                .get_main_input_signal_start = war_share_get_main_input_signal_start,
                .get_main_input_signal_no = war_share_get_main_input_signal_no,
                .get_total_signal_no = war_share_get_total_signal_no,
                .get_number_of_components = war_share_get_number_of_components,
                .get_size_of_input_hashmap = war_share_get_size_of_input_hashmap,
                .get_size_of_witness = war_share_get_size_of_witness,
                .get_size_of_constants = war_share_get_size_of_constants,
                .get_size_of_io_map = war_share_get_size_of_io_map,
                .get_size_of_bus_field_map = war_share_get_size_of_bus_field_map,
            },
        };
    } else
    if (std.mem.eql(u8, name, "war_showdown")) {
        return .{
            .loadCircuit = war_showdown_loadCircuitFromData,
            .create_ctx = war_showdown_create_ctx,
            .get_size = war_showdown_get_size_of_witness,
            .vtable = .{
                .get_main_input_signal_start = war_showdown_get_main_input_signal_start,
                .get_main_input_signal_no = war_showdown_get_main_input_signal_no,
                .get_total_signal_no = war_showdown_get_total_signal_no,
                .get_number_of_components = war_showdown_get_number_of_components,
                .get_size_of_input_hashmap = war_showdown_get_size_of_input_hashmap,
                .get_size_of_witness = war_showdown_get_size_of_witness,
                .get_size_of_constants = war_showdown_get_size_of_constants,
                .get_size_of_io_map = war_showdown_get_size_of_io_map,
                .get_size_of_bus_field_map = war_showdown_get_size_of_bus_field_map,
            },
        };
    } else
    {
...
fn getCircuitData(name: []const u8) ![]const u8 {
    if (std.mem.eql(u8, name, "war_share")) return witness_dat.getCircuitDat("war_share");
    if (std.mem.eql(u8, name, "war_showdown")) return witness_dat.getCircuitDat("war_showdown");

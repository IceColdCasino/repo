...
extern "c" fn baccarat_share_loadCircuitFromData(data: [*c]const u8, size: usize, vtable: *anyopaque) ?*anyopaque;
extern "c" fn baccarat_share_create_ctx(circuit: *anyopaque) ?*anyopaque;
extern "c" fn baccarat_share_get_main_input_signal_start() u32;
extern "c" fn baccarat_share_get_main_input_signal_no() u32;
extern "c" fn baccarat_share_get_total_signal_no() u32;
extern "c" fn baccarat_share_get_number_of_components() u32;
extern "c" fn baccarat_share_get_size_of_input_hashmap() u32;
extern "c" fn baccarat_share_get_size_of_witness() u32;
extern "c" fn baccarat_share_get_size_of_constants() u32;
extern "c" fn baccarat_share_get_size_of_io_map() u32;
extern "c" fn baccarat_share_get_size_of_bus_field_map() u32;

extern "c" fn baccarat_showdown_loadCircuitFromData(data: [*c]const u8, size: usize, vtable: *anyopaque) ?*anyopaque;
extern "c" fn baccarat_showdown_create_ctx(circuit: *anyopaque) ?*anyopaque;
extern "c" fn baccarat_showdown_get_main_input_signal_start() u32;
extern "c" fn baccarat_showdown_get_main_input_signal_no() u32;
extern "c" fn baccarat_showdown_get_total_signal_no() u32;
extern "c" fn baccarat_showdown_get_number_of_components() u32;
extern "c" fn baccarat_showdown_get_size_of_input_hashmap() u32;
extern "c" fn baccarat_showdown_get_size_of_witness() u32;
extern "c" fn baccarat_showdown_get_size_of_constants() u32;
extern "c" fn baccarat_showdown_get_size_of_io_map() u32;
extern "c" fn baccarat_showdown_get_size_of_bus_field_map() u32;
...
fn getCircuitFunctions(name: []const u8) ?struct {
    ...
    if (std.mem.eql(u8, name, "baccarat_share")) {
        return .{
            .loadCircuit = baccarat_share_loadCircuitFromData,
            .create_ctx = baccarat_share_create_ctx,
            .get_size = baccarat_share_get_size_of_witness,
            .vtable = .{
                .get_main_input_signal_start = baccarat_share_get_main_input_signal_start,
                .get_main_input_signal_no = baccarat_share_get_main_input_signal_no,
                .get_total_signal_no = baccarat_share_get_total_signal_no,
                .get_number_of_components = baccarat_share_get_number_of_components,
                .get_size_of_input_hashmap = baccarat_share_get_size_of_input_hashmap,
                .get_size_of_witness = baccarat_share_get_size_of_witness,
                .get_size_of_constants = baccarat_share_get_size_of_constants,
                .get_size_of_io_map = baccarat_share_get_size_of_io_map,
                .get_size_of_bus_field_map = baccarat_share_get_size_of_bus_field_map,
            },
        };
    } else
    if (std.mem.eql(u8, name, "baccarat_showdown")) {
        return .{
            .loadCircuit = baccarat_showdown_loadCircuitFromData,
            .create_ctx = baccarat_showdown_create_ctx,
            .get_size = baccarat_showdown_get_size_of_witness,
            .vtable = .{
                .get_main_input_signal_start = baccarat_showdown_get_main_input_signal_start,
                .get_main_input_signal_no = baccarat_showdown_get_main_input_signal_no,
                .get_total_signal_no = baccarat_showdown_get_total_signal_no,
                .get_number_of_components = baccarat_showdown_get_number_of_components,
                .get_size_of_input_hashmap = baccarat_showdown_get_size_of_input_hashmap,
                .get_size_of_witness = baccarat_showdown_get_size_of_witness,
                .get_size_of_constants = baccarat_showdown_get_size_of_constants,
                .get_size_of_io_map = baccarat_showdown_get_size_of_io_map,
                .get_size_of_bus_field_map = baccarat_showdown_get_size_of_bus_field_map,
            },
        };
    } else
    {
...
fn getCircuitData(name: []const u8) ![]const u8 {
    if (std.mem.eql(u8, name, "baccarat_share")) return witness_dat.getCircuitDat("baccarat_share");
    if (std.mem.eql(u8, name, "baccarat_showdown")) return witness_dat.getCircuitDat("baccarat_showdown");

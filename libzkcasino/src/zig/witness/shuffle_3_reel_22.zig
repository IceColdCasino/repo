...
extern "c" fn shuffle_3_reel_22_loadCircuitFromData(data: [*c]const u8, size: usize, vtable: *anyopaque) ?*anyopaque;
extern "c" fn shuffle_3_reel_22_create_ctx(circuit: *anyopaque) ?*anyopaque;
extern "c" fn shuffle_3_reel_22_get_main_input_signal_start() u32;
extern "c" fn shuffle_3_reel_22_get_main_input_signal_no() u32;
extern "c" fn shuffle_3_reel_22_get_total_signal_no() u32;
extern "c" fn shuffle_3_reel_22_get_number_of_components() u32;
extern "c" fn shuffle_3_reel_22_get_size_of_input_hashmap() u32;
extern "c" fn shuffle_3_reel_22_get_size_of_witness() u32;
extern "c" fn shuffle_3_reel_22_get_size_of_constants() u32;
extern "c" fn shuffle_3_reel_22_get_size_of_io_map() u32;
extern "c" fn shuffle_3_reel_22_get_size_of_bus_field_map() u32;
...
fn getCircuitFunctions(name: []const u8) ?struct {
    ...
    if (std.mem.eql(u8, name, "shuffle_3_reel_22")) {
        return .{
            .loadCircuit = shuffle_3_reel_22_loadCircuitFromData,
            .create_ctx = shuffle_3_reel_22_create_ctx,
            .get_size = shuffle_3_reel_22_get_size_of_witness,
            .vtable = .{
                .get_main_input_signal_start = shuffle_3_reel_22_get_main_input_signal_start,
                .get_main_input_signal_no = shuffle_3_reel_22_get_main_input_signal_no,
                .get_total_signal_no = shuffle_3_reel_22_get_total_signal_no,
                .get_number_of_components = shuffle_3_reel_22_get_number_of_components,
                .get_size_of_input_hashmap = shuffle_3_reel_22_get_size_of_input_hashmap,
                .get_size_of_witness = shuffle_3_reel_22_get_size_of_witness,
                .get_size_of_constants = shuffle_3_reel_22_get_size_of_constants,
                .get_size_of_io_map = shuffle_3_reel_22_get_size_of_io_map,
                .get_size_of_bus_field_map = shuffle_3_reel_22_get_size_of_bus_field_map,
            },
        };
    } else
    {
...
fn getCircuitData(name: []const u8) ![]const u8 {
    if (std.mem.eql(u8, name, "shuffle_3_reel_22")) return witness_dat.getCircuitDat("shuffle_3_reel_22");

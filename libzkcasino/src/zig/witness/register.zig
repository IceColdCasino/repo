...
extern "c" fn register_loadCircuitFromData(data: [*c]const u8, size: usize, vtable: *anyopaque) ?*anyopaque;
extern "c" fn register_create_ctx(circuit: *anyopaque) ?*anyopaque;
extern "c" fn register_get_main_input_signal_start() u32;
extern "c" fn register_get_main_input_signal_no() u32;
extern "c" fn register_get_total_signal_no() u32;
extern "c" fn register_get_number_of_components() u32;
extern "c" fn register_get_size_of_input_hashmap() u32;
extern "c" fn register_get_size_of_witness() u32;
extern "c" fn register_get_size_of_constants() u32;
extern "c" fn register_get_size_of_io_map() u32;
extern "c" fn register_get_size_of_bus_field_map() u32;
...
fn getCircuitFunctions(name: []const u8) ?struct {
    ...
    if (std.mem.eql(u8, name, "register")) {
        return .{
            .loadCircuit = register_loadCircuitFromData,
            .create_ctx = register_create_ctx,
            .get_size = register_get_size_of_witness,
            .vtable = .{
                .get_main_input_signal_start = register_get_main_input_signal_start,
                .get_main_input_signal_no = register_get_main_input_signal_no,
                .get_total_signal_no = register_get_total_signal_no,
                .get_number_of_components = register_get_number_of_components,
                .get_size_of_input_hashmap = register_get_size_of_input_hashmap,
                .get_size_of_witness = register_get_size_of_witness,
                .get_size_of_constants = register_get_size_of_constants,
                .get_size_of_io_map = register_get_size_of_io_map,
                .get_size_of_bus_field_map = register_get_size_of_bus_field_map,
            },
        };
    } else
    {
...
fn getCircuitData(name: []const u8) ![]const u8 {
    if (std.mem.eql(u8, name, "register")) return witness_dat.getCircuitDat("register");
